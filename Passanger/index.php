<?php
  ...
  if(isset($_POST['submit'])){
    if(empty($_POST['reservationno']) || empty($_POST['passengerid']) || empty($_POST['driverid']) || empty($_POST['startplace']) || empty($_POST['endplace']) || empty($_POST['status'])){
      ...
      echo "<script> alert('Please wait for the driver to reach your place!!.'); </script>";        
              ...
              <div class="card-body">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    $table_result=mysqli_query($connection,"SELECT * FROM reservation WHERE passengerid='$id_value'");  //input table name and id of passenger to retrive respective passenger booking details
