		...
		if(empty($_POST['email']) || empty($_POST['password'])){
			...
			if(mysqli_num_rows($result)>0){
				if($password==$row["password"]){
					...
					$id_result=mysqli_query($connection,"SELECT * FROM driver WHERE driveremail='$username'");
			        $id_row=mysqli_fetch_assoc($id_result);					
					$_SESSION['driverid']=$id_row['driverid'];
					$_SESSION['drivername']=$id_row['drivername'];                          
				}
				else{
			  ...
			  <header id="header">
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
						...
						<ul class="nav-menu">
							  <li class="menu-active"><a class="dropdown-item" href="index.php">Home</a></li>
							  <li><a class="dropdown-item" href="about.html">About</a></li>
							  <li><a class="dropdown-item" href="driver-login.php">Driver</a></li>
							  <li><a class="dropdown-item" href="operator-login.php">Operator</a></li>  
					...
					<div class="form-row section-title">
						<form class="form" action="" method="POST">
							...
							<div class="form-group">
								<button class="btn btn-default btn-lg btn-block text-center text-uppercase" type="submit" name="submit">Login</button>
							</div>
							<p class="register">
								<u><a href="driver-register.php">Not registered!Click here.</a></u>
							</p>
					  </form>												
					</div>												
				</div>
