<?php
  ...
  $user_name=mysqli_query($connection,"SELECT username FROM user");

  //code for update password of users
              ...
              <div class="card-body">
                ...
                <form class="row g-3" action="" method="POST">
                  <div class="col-6">
                    ...
                    <select class="form-control" name="username" id="doc-type">
              ...
              <div class="card-body">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    $table_result=mysqli_query($connection,"SELECT * FROM user");  //input table name and id of passenger to retrive respective user details
                    while($row=mysqli_fetch_array($table_result))
                    {
                     ?>
                       <tr>
                         ...
                         <td><a href="delete_logindetails.php?id=<?php echo $row['username']; ?>"><button type="button" name="delete" class="btn btn-danger">Delete</button></a></td>
                         <td><a href="/city-taxi/phpmailer/send_mail.php?id=<?php echo $row['username']; ?>"><button type="submit" name="send_mail" class="btn btn-secondary">Mail it</button></a></td>
                       </tr>	
                      <?php
                    }
                    ?>                   
