<?php
  ...
  if(isset($_POST['submit'])){
    if(empty($_POST['passengerid']) || empty($_POST['passengername']) || empty($_POST['passengeremail']) || empty($_POST['passengerphoneno']) || empty($_POST['passengeraddress'])){
      ...
      echo "<script> alert('Insertion successful.Reserve driver from reservation option.'); </script>";      
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Register Passengers</h5>
  
                <!-- Vertical Form -->
                <form class="row g-3" action="" method="POST">
                  <div class="col-6">
                    <label for="inputNanme4" class="form-label">Passenger ID</label>
                    <input type="text" name="passengerid" class="form-control" value="<?php echo $new_pid; ?>" id="inputNanme4" readonly>
                  </div>
  ...
  //script for auto filling address
  <script>
